...
-- require("config.plugins.lsp.lspconfig.languages.c_sharp")
-- require("config.plugins.lsp.lspconfig.languages.sql")
require("config.plugins.lsp.lspconfig.languages.bash")
