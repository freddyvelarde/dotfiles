...
tar -xvf archcraft-icons-zafiro-1.0-5-any.pkg.tar.zst  tar -xvf archcraft-icons-luna-1.0-5-any.pkg.tar.zst archcraft-cursor-qogirr-1.0-4-any.pkg.tar.zst archcraft-cursor-fluent-1.0-4-any.pkg.tar.zst
